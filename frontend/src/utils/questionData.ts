...
export const QUESTIONS = [
  {
    ...
    options: [
      ...
      { text: 'Building frontend interfaces and web experiences' },
      { text: 'Backend development, APIs, and database design' },
      { text: 'Data engineering and large-scale data pipelines' },
      { text: 'Automating workflows using no-code and AI tools' },
      { text: 'Developer advocacy, technical writing, or community building' },
      { text: 'Virtual assistance and supporting remote teams' },
      { text: 'DevSecOps and securing software delivery pipelines' },
      { text: 'Exploring emerging technologies and what comes next' },
