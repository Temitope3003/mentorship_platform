...
export function buildCertificateDocument(reactPdf: any, props: CertificateDocumentProps) {
  const { Document, Page, View, Text, StyleSheet } = reactPdf
  const { menteeName, domainTrack, completionDateFormatted, certificateCode } = props
