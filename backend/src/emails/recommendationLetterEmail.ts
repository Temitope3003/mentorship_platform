...
interface RecommendationLetterEmailData {
  name: string
  email: string
  pdfBuffer: Buffer
}

export async function sendRecommendationLetterEmail(data: RecommendationLetterEmailData) {
  ...
  <div style="max-width:600px;margin:0 auto;padding:40px 20px;">
    ...
    <div style="background:#0F1F3D;border-radius:16px 16px 0 0;padding:36px 40px;">
      ...
      <p style="margin:8px 0 0;color:#C9A84C;font-size:14px;">
        Personally written for you by your mentor
      </p>
    </div>
    ...
    <div style="background:#ffffff;border-radius:0 0 16px 16px;padding:40px;border:1px solid #E8E4D9;border-top:none;">
      ...
      <p style="margin:0 0 20px;color:#4A4A4A;font-size:15px;line-height:1.7;">
        As a Premium member, you've earned a personal letter of recommendation from your mentor. It's attached to this email as a PDF — feel free to use it in job applications, LinkedIn, or anywhere it adds weight to your story.
      </p>
